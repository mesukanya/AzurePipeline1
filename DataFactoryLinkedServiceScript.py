...
LINKEDSERVICE_NAME = "LinkedserviceDataFactory"
...
BODY = {
  "properties": {
    ...
    "typeProperties": {
      "connectionString": {
        "type": "SecureString",
        "value": "DefaultEndpointsProtocol=https;AccountName=sukanyastorageaccount;AccountKey=nnfJ4N99xI9bgjuwebp3muNGzTpnEEnKwBMgSi9MKYXN372PwjoEG+huYLw1LorjnWIq9JVFOcestH46Jg4rgA=="
      }
    }
  }
}
