...
WORKSPACE_NAME = "sukanyadatabriks"
MANAGERESOURCEGROUP="sukanyadatabriks"

BODY = {
  "properties": {
    "managedResourceGroupId": "/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + MANAGERESOURCEGROUP
  },
  "location": "eastus2"
}
